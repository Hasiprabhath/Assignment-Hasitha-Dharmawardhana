...
<footer style="background: linear-gradient(#fbf1e4, white, #fbf1e4);">
  <div class="container py-5 d-flex flex-column justify-content-center mx-auto text-center">
    <div class="pb-1">
      <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2023/08/Capture-removebg-preview.png" class="img-fluid">
    </div>
    <div class="pb-1">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 d-flex justify-content-end">
          <a href="#" class="text-decoration-none">
            <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2023/08/side-bar-logo.png" class="img-fluid object-fit-cover" height="40" width="40">
          </a>
        </div>
      </div>
    </div>

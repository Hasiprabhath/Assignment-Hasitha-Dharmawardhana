    ...
    <div class="container">
      ...
      <nav class="navbar bg-transparent py-4">
        <div class="container-fluid">
          <a class="navbar-brand" href="#"><img src="images/Capture-removebg-preview.png" class="img-fluid"></a>
          <div class="ms-auto">
            <button class="border-0 mx-lg-3 bg-transparent"><img src="images/02cc464b-db4f-4cff-9fa3-f05f306bb064.png" class="img-fluid"></button>
            <button class="navbar-toggler mx-lg-3 border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar" aria-label="Toggle navigation">
              <span>
                <img src="images/a790d8e4-b45e-4d38-9150-2339f3a88c2a.png" class="img-fluid">
              </span>
            </button>
            <button class="navbar-toggler mx-lg-3 border-0" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggleExternalContent" aria-controls="navbarToggleExternalContent" aria-expanded="false" aria-label="Toggle navigation">
              <span>
                <img src="images/9a179aa8-da06-4d75-9760-46af72f97b9f.png" class="img-fluid">
              </span>
            </button>
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel" style="background: linear-gradient(#fbf1e4, white, #fbf1e4);width: 550px;">
              ...
              <div class="offcanvas-body">
                ...
                <div class="py-1">
                  <div class="row">
                    <div class="col-lg-3">
                      <img src="images/d0d21132-d792-4c99-8b89-ebee2245367d.png" class="img-fluid" height="80" width="80">
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="py-1">
                  <div class="row">
                    <div class="col-lg-3">
                      <img src="images/fcd2d22b-b337-4736-b274-4b89d5ecfe6e.png" class="img-fluid" height="80" width="80">
                    </div>
                    <div class="col-lg-6">
                      <div class="card border-0 h-100 bg-transparent">
                        <div class="card-body">
